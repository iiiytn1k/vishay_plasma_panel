const uint8_t font [225][5] PROGMEM = {
	...
	{0x08, 0x08, 0x2a, 0x1c, 0x08 },// ÒÚÂÎÍ‡ ‚ÎÂ‚Ó 0x7F 127
	{0x08, 0x1c, 0x2a, 0x08, 0x08 },// ÒÚÂÎÍ‡ ‚Ô‡‚Ó 0x80 128
	{0xFF, 0xFF, 0xFF, 0xFF, 0xFF },// Á‡ÔÓÎÌÂÌ˚È ÒËÏ‚ÓÎ 0x81 129
	{0xD5, 0xAA, 0xD5, 0xAA, 0xD5 },//  0x82 130
	{0x00, 0x00, 0x00, 0x00, 0x00 },// É 0x83 131
	{0x00, 0x00, 0x00, 0x00, 0x00 },// Ñ 0x84 132
	{0x40, 0x00, 0x40, 0x00, 0x40 },// Ö 0x85 133
	{0x04, 0x04, 0xFF, 0x04, 0x04 },// Ü 0x86 134
	{0x24, 0x24, 0xFF, 0x24, 0x24 },// á 0x87 135
	{0x28, 0x7C, 0xAA, 0xAA, 0x82 },// à 0x88 136
	{0x00, 0x00, 0x00, 0x00, 0x00 },// â 0x89 137
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ä 0x8A 138
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ã 0x8B 139
	{0x00, 0x00, 0x00, 0x00, 0x00 },// å 0x8C 140
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ç 0x8D 141
	{0x00, 0x00, 0x00, 0x00, 0x00 },// é 0x8E 142
	{0x00, 0x00, 0x00, 0x00, 0x00 },// è 0x8F 143
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ê 0x90 144
	{0x00, 0x06, 0x05, 0x00, 0x00 },// ë 0x91 145
	{0x00, 0x00, 0x05, 0x03, 0x00 },// í 0x92 146
	{0x06, 0x05, 0x00, 0x06, 0x05 },// ì 0x93 147
	{0x05, 0x03, 0x00, 0x05, 0x03 },// î 0x94 148
	{0x18, 0x3C, 0x3C, 0x3C, 0x18 },// ï 0x95 149
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ñ 0x96 150
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ó 0x97 151
	{0x78, 0x48, 0x48, 0x78, 0x00 },// ò 0x98 152
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ô 0x99 153
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ö 0x9A 154
	{0x00, 0x00, 0x00, 0x00, 0x00 },// õ 0x9B 155
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ú 0x9C 156
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ù 0x9D 157
	{0x00, 0x00, 0x00, 0x00, 0x00 },// û 0x9E 158
	{0x00, 0x00, 0x00, 0x00, 0x00 },// ü 0x9F 159
	...
	{0x4A, 0x95, 0xA5, 0xA9, 0x52 },// ß 0xA7 167
	...
	{0x00, 0x00, 0x00, 0x00, 0x00 },// Æ 0xAE 174
	{0x00, 0x45, 0x7C, 0x45, 0x00 },// Ø 0xAF 175
	...
	{0x78, 0x10, 0x20, 0x7B, 0x03 },// π 0xB9 185
	{0x38, 0x54, 0x54, 0x44, 0x00 },// ∫ 0xBA 186
	{0x22, 0x14, 0x2A, 0x14, 0x08 },// ª 0xBB 187
	{0x00, 0x00, 0x00, 0x00, 0x00 },// º 0xBC 188
	{0x00, 0x00, 0x00, 0x00, 0x00 },// Ω 0xBD 189
	{0x00, 0x00, 0x00, 0x00, 0x00 },// æ 0xBE 190
	{0x00, 0x54, 0x70, 0x44, 0x00 },// ø 0xBF 191
	...
	{0x60, 0x3F, 0x21, 0x3F, 0x60 },// ƒ 0xC4 196
	...
	{0x40, 0x3E, 0x01, 0x01, 0x7F },// À 0xCB 203
	{0x7F, 0x02, 0x0C, 0x02, 0x7F },// Ã 0xCC 204
	{0x7F, 0x08, 0x08, 0x08, 0x7F },// Õ 0xCD 205
	{0x3E, 0x41, 0x41, 0x41, 0x3E },// Œ 0xCE 206
	{0x7F, 0x01, 0x01, 0x01, 0x7F },// œ 0xCF 207
	...
	{0x7F, 0x40, 0x7E, 0x40, 0x7F },// ÿ 0xD8 216
	{0x3F, 0x20, 0x3F, 0x20, 0x7F },// Ÿ 0xD9 217
	...
	{0x7F, 0x08, 0x3E, 0x41, 0x3E },// ﬁ 0xDE 222
	{0x46, 0x29, 0x19, 0x09, 0x7F },// ﬂ 0xDF 223
	...
	{0x38, 0x54, 0x54, 0x54, 0x18 },// Â 0xE5 229
	{0x6C, 0x10, 0x7C, 0x10, 0x6C },// Ê 0xE6 230
	{0x00, 0x44, 0x54, 0x54, 0x28 },// Á 0xE7 231
	{0x7C, 0x20, 0x10, 0x08, 0x7C },// Ë 0xE8 232
	{0x7C, 0x21, 0x12, 0x09, 0x7C },// È 0xE9 233
	{0x7C, 0x10, 0x28, 0x44, 0x00 },// Í 0xEA 234
	{0x40, 0x38, 0x04, 0x04, 0x7C },// Î 0xEB 235
	{0x7C, 0x08, 0x10, 0x08, 0x7C },// Ï 0xEC 236
	{0x7C, 0x10, 0x10, 0x10, 0x7C },// Ì 0xED 237
	{0x38, 0x44, 0x44, 0x44, 0x38 },// Ó 0xEE 238
	{0x7C, 0x04, 0x04, 0x04, 0x7C },// Ô 0xEF 239
	{0x7C, 0x14, 0x14, 0x14, 0x08 },//  0xF0 240
	{0x38, 0x44, 0x44, 0x44, 0x00 },// Ò 0xF1 241
	{0x04, 0x04, 0x7C, 0x04, 0x04 },// Ú 0xF2 242
	{0x0C, 0x50, 0x50, 0x50, 0x3C },// Û 0xF3 243
	{0x08, 0x14, 0x7C, 0x14, 0x08 },// Ù 0xF4 244
	{0x44, 0x28, 0x10, 0x28, 0x44 },// ı 0xF5 245
	{0x3C, 0x20, 0x20, 0x3C, 0x60 },// ˆ 0xF6 246
	...
	{0x48, 0x54, 0x34, 0x14, 0x7C } // ˇ 0xFF 255
};